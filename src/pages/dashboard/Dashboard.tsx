  ...
  return (
    <Stack gap="lg">
      ...
      <Alert
        ...
        variant="light"
      >
        Este é um ambiente de demonstração com dados fake. Explore todas as funcionalidades!
      </Alert>
        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder>
          <Group justify="apart">
            <div>
              ...
              <Text size="xl" fw={700}>
                {isLoading ? <Skeleton height={30} width={60} /> : stats?.totalMembers}
              </Text>
            </div>
          ...
          <Group justify="apart">
            <div>
              ...
              <Text
                size="xl"
                fw={700}
                c={stats ? getBalanceColor(stats.financialSummary.balance) : 'gray'}
              >
                {isLoading ? (
                  <Skeleton height={30} width={100} />
                ) : (
            ...
            <ThemeIcon
              ...
              radius="md"
              variant="light"
              color={stats ? getBalanceColor(stats.financialSummary.balance) : 'gray'}
            >
            ...
            {isLoading ? (
              ...
              <Stack gap="md">
                {stats.upcomingSchedules.slice(0, 5).map((schedule) => {
                  const confirmed = schedule.volunteers?.filter(
                  ...
                  return (
                    <Box key={schedule.id}>
                      ...
                      <Progress value={percentage} color={percentage === 100 ? 'green' : 'yellow'} />
                    </Box>
                  );
                })}
              </Stack>
